...
public class MergedJobDriver {
    ...
    public static class AnonymizeDistinctMergedReducer extends Reducer<TaggedText, Text, Text, NullWritable> {
        ...
        @Override
        protected void reduce(TaggedText key, Iterable<Text> values, Context context) throws IOException,
        ...
        private void anonymizeReduce(Text key, Iterable<Text> values, Context context) throws IOException,
                InterruptedException {
        ...
        private void distinctReduce(Text key, Iterable<Text> values, Context context) throws IOException,
                InterruptedException {

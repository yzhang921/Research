...
public class ReadSequenceFileArtist {
    ...
    public static void main(String[] argvs) throws IOException {
        String filename = "D:/Study/Workspaces/HadoopDevWS/mcksrc/output/02/part-0000";
        Path path = new Path(filename);

        String outputfilename = "D:/Study/Workspaces/HadoopDevWS/mcksrc/output/02/dump.csv";
